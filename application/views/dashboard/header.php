...
<head>
       ...
       <!-- PER ITEM CSS FILES START -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/itemCssFiles/font-awesome.min.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/itemCssFiles/main.css">   
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/itemCssFiles/prettyPhoto.css">  
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/itemCssFiles/price-range.css">  
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/bxslider/jquery.bxslider.min.css">
        <!-- PER ITEM CSS FILES END -->

        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/itemCssFiles/responsive.css">

        <script src="<?php echo base_url() ?>assets/js/media-match/media.match.min.js"></script>
...
<body class="site-navbar-small dashboard" style="    overflow-x: hidden;">
<!--[if lt IE 8]>
